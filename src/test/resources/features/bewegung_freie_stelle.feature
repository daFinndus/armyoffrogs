# language: de
Funktionalität: Das Plugin muss gewährleisten, dass die Bewegung über die Seiten der anderen Spielsteine hinweg
  ...
  Szenario: Bewegung über die Seiten der anderen Spielsteine hinweg bis zur nächsten freien Stelle
    ...
    Wenn der Speielr seinen Frosch bewegen möchte
